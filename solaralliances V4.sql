...
--
-- Host: localhost:3306
-- Generation Time: Apr 27, 2021 at 04:47 PM
...
INSERT INTO `player` (`Player_Id`, `Name`, `Email`, `Password`, `Rank`, `Faction`) VALUES
(7, 'Leon', 'Email', '123', 1, 2),
(8, 'Name', 'Email', 'Password', 1, 2),
(9, 'Joao', 'Email', '1234', 1, 2);
...
(1, 1000, 1000, 1000, 100, 100, 1000, 1000, 8);
...
--
ALTER TABLE `player_resources`
  MODIFY `PResource_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
