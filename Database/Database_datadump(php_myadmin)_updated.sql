...
--
-- Host: localhost:3306
-- Generation Time: Jun 08, 2021 at 03:14 PM
...
(1, 'Test Mission', 'Description and story', '00:02:00', 5, 100, 0, 0, 350, 100, 0, 0, 0, 10, 0, 10, 0, 0, 0, 60, 0, 0, 6, 1, 'MEB'),
(3, 'Great Mining Alliance', 'Description and story', '00:59:00', 5, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 30, 300, 2, 1, 'MEB'),
(4, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(5, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(6, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(7, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(8, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(9, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(10, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(11, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(12, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(13, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB'),
(14, 'Great Mining Alliance', 'Description and story', '00:59:00', 4, 400, 0, 300, 0, 0, 100, 0, 1000, 10, 100, 0, 10, 0, 0, 0, 10, 100, 0, 1, 'MEB');
...
(3, 1, 8, 9, 4, 5, 3, '00:05:00'),
(21, 68, 8, 5, 3, 6, 4, '00:05:00');
...
(12, 350, 370, 500, 60, 150, 1050, 1050, 1),
(30, 200, 90, 200, 90, 100, 1000, 1000, 68);
...
--
ALTER TABLE `accepted_multiplayer_missions`
  MODIFY `amm_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `accepted_solomissions`
--
ALTER TABLE `accepted_solomissions`
  MODIFY `asm_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=317;
...
--
ALTER TABLE `multiplayer_missions`
  MODIFY `MMissions_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `player_missions`
  MODIFY `Player_Mission_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `player_resources`
--
ALTER TABLE `player_resources`
  MODIFY `PResource_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `ship_fleet`
  MODIFY `Ship_Fleet_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `solo_missions`
--
ALTER TABLE `solo_missions`
  MODIFY `Solo_Missions_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
